def analyze_etf_outperformance_templated():
    import json
    ...
    active_symbols_data = step_data.get('active_symbols')
    ...
    return {
        ...
        'template_substitution_used': True,
        'active_symbols_from_step2': list(etf_bars.keys()) if etf_bars else []
    }