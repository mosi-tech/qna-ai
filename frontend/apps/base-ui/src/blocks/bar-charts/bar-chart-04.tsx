...
export interface SummaryTabItem {
    ...
    /** Optional label for the period comparison (defaults to "to last period") */
    periodLabel?: string;
    data: BarChartDataItem[];
    details: DetailItem[];
}

export interface BarChart04Props {
...
export const BarChart04: React.FC<BarChart04Props> = ({
    summary = [],
    title,
    indexField = 'date',
    categories = [],
                        ...
                        <React.Fragment key={tab.name}>
                            ...
                            >
                                ...
                                <p className="mt-1 text-xs text-gray-500 dark:text-gray-500">
                                    ...
                                    {tab.periodLabel || 'vs previous period'}
                                </p>
                            </TabsTrigger>
