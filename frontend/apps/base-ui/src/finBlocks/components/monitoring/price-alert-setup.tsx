...
// Data interface for Price Alert Monitoring
...
export const SAMPLE_DATA: PriceAlertSetupProps = {
...
export const PriceAlertSetup: React.FC<PriceAlertSetupProps> = ({
  ...
  return (
    <div className="finblock price-alert-setup rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
