...
// Data interface for Portfolio KPI Summary
...
export const SAMPLE_DATA: PortfolioKpiSummaryProps = {
 ...
 * @blockType kpi-card
 * @concepts portfolio value, P&L, returns, risk-adjusted returns
...
export const PortfolioKpiSummary: React.FC<PortfolioKpiSummaryProps> = ({
  ...
  return (
    <div className="finblock portfolio-kpi-summary rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
